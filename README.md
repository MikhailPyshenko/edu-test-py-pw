...
* Основной функционал - UI скрипты на `python` с использованием библиотеки `playwright`.
  * Так же есть простой api тест с использованием ```requests``` и простой нагрузочный тест с использованием ```locust```
* В качестве примера автоматизируется проект [saucedemo](https://www.saucedemo.com/v1/)
  * Есть простые тесты для проектов [example](https://www.example.com/) и [demoqa](https://demoqa.com/)
